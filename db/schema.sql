...
-- CONTRACT TABLE — do not modify schema without coordinating hamm0r + evaluat0r
...
-- OWNED BY evaluat0r — hamm0r never writes here
...
-- OWNED BY hamm0r — scenario-based testing
...
-- OWNED BY hamm0r — findings promoted from workbench results
CREATE TABLE IF NOT EXISTS findings (
    id           TEXT PRIMARY KEY,
    result_id    TEXT REFERENCES results(id),
    title        TEXT NOT NULL,
    severity     TEXT NOT NULL,   -- LOW | MEDIUM | HIGH | CRITICAL
    owasp_refs   TEXT NOT NULL DEFAULT '[]',  -- JSON array
    notes        TEXT,
...
CREATE INDEX IF NOT EXISTS idx_findings_result ON findings(result_id);
